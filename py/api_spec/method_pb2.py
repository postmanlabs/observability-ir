...
_HTTPMETHODERROR_ERRORTYPE = _descriptor.EnumDescriptor(
  name='errorType',
  full_name='api_spec.HTTPMethodError.errorType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='AGENT_TIMEOUT', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='AGENT_PARSING_ERROR', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CLIENT_TIMEOUT', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SERVER_TIMEOUT', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONNECTION_RESET', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_HTTPMETHODERROR_ERRORTYPE)
...
_HTTPMETHODERROR = _descriptor.Descriptor(
  name='HTTPMethodError',
  full_name='api_spec.HTTPMethodError',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='api_spec.HTTPMethodError.type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='message', full_name='api_spec.HTTPMethodError.message', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METHODMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='errors', full_name='api_spec.MethodMeta.errors', index=2,
...
_HTTPMETHODERROR.fields_by_name['type'].enum_type = _HTTPMETHODERROR_ERRORTYPE
_HTTPMETHODERROR_ERRORTYPE.containing_type = _HTTPMETHODERROR
_METHODMETA.fields_by_name['grpc'].message_type = _GRPCMETHODMETA
_METHODMETA.fields_by_name['http'].message_type = _HTTPMETHODMETA
_METHODMETA.fields_by_name['errors'].message_type = _HTTPMETHODERROR
...
DESCRIPTOR.message_types_by_name['HTTPMethodError'] = _HTTPMETHODERROR
...
HTTPMethodError = _reflection.GeneratedProtocolMessageType('HTTPMethodError', (_message.Message,), {
  'DESCRIPTOR' : _HTTPMETHODERROR,
  '__module__' : 'method_pb2'
  # @@protoc_insertion_point(class_scope:api_spec.HTTPMethodError)
  })
_sym_db.RegisterMessage(HTTPMethodError)
