...
type Primitive struct {
	...
	CountByDataFormat map[string]int64 `protobuf:"bytes,15,rep,name=count_by_data_format,json=countByDataFormat,proto3" json:"count_by_data_format,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *Primitive) GetCountByDataFormat() map[string]int64 {
	if x != nil {
...
type Data struct {
	...
	Tracking *AkitaWitnessTracking `protobuf:"bytes,9,opt,name=tracking,proto3" json:"tracking,omitempty"`
}
...
var file_method_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x22, 0xc7, 0x07, 0x0a, 0x09, 0x50, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76,
	...
	0x63, 0x6b, 0x69, 0x6e, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x70,
...
var file_method_proto_depIdxs = []int32{
	...
	30, // 56: api_spec.Struct.FieldsEntry.value:type_name -> api_spec.Data
	30, // 57: api_spec.OneOf.OptionsEntry.value:type_name -> api_spec.Data
	29, // 58: api_spec.Data.ExampleValuesEntry.value:type_name -> api_spec.ExampleValue
	30, // 59: api_spec.Method.ArgsEntry.value:type_name -> api_spec.Data
	30, // 60: api_spec.Method.ResponsesEntry.value:type_name -> api_spec.Data
