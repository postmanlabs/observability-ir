...
func (x *AkitaWitnessTracking) GetLastSeen() *timestamppb.Timestamp {
	if x != nil {
		return x.LastSeen
	}
	return nil
...
func (x *AkitaWitnessTracking) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_tracking_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x73, 0x74, 0x53, 0x65, 0x65, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x2c,
...
var file_tracking_proto_depIdxs = []int32{
	...
	1, // 1: api_spec.AkitaWitnessTracking.last_seen:type_name -> google.protobuf.Timestamp
