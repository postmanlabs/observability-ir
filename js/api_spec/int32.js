...
goog.provide('proto.api_spec.Int32');
...
proto.api_spec.Int32.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: (f = msg.getType()) && proto.api_spec.Int32Type.toObject(includeInstance, f),
...
proto.api_spec.Int32.prototype.getType = function() {
  return /** @type{?proto.api_spec.Int32Type} */ (
    jspb.Message.getWrapperField(this, proto.api_spec.Int32Type, 1));
};
