...
goog.provide('proto.api_spec.String');
...
proto.api_spec.String.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: (f = msg.getType()) && proto.api_spec.StringType.toObject(includeInstance, f),
...
proto.api_spec.String.prototype.getType = function() {
  return /** @type{?proto.api_spec.StringType} */ (
    jspb.Message.getWrapperField(this, proto.api_spec.StringType, 1));
};
