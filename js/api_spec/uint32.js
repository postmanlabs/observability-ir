...
goog.provide('proto.api_spec.Uint32');
...
proto.api_spec.Uint32.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: (f = msg.getType()) && proto.api_spec.Uint32Type.toObject(includeInstance, f),
...
proto.api_spec.Uint32.prototype.getType = function() {
  return /** @type{?proto.api_spec.Uint32Type} */ (
    jspb.Message.getWrapperField(this, proto.api_spec.Uint32Type, 1));
};
